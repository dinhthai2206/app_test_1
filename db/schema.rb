...
ActiveRecord::Schema.define(version: 2019_07_01_085821) do
  ...
  create_table "user_answers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_test_id"], name: "index_user_answers_on_user_test_id"
  end

  create_table "user_tests", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "test_id"
    t.float "score"
    t.datetime "created_at", null: false
  ...
  add_foreign_key "user_answers", "user_tests"
